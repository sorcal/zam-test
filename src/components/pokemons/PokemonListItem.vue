  ...
  <tr>
    <td class="whitespace-nowrap py-2 pl-4 pr-3 text-sm sm:pl-0">
      <div class="flex items-center">
        ...
        <div class="ml-4 text-left">
          <div class="font-medium text-gray-900 capitalize" data-test-id="name">
            {{ pokemon.name }}
          </div>
        </div>
      </div>
    ...
    >
      <RouterLink
        ...
        data-test-id="view-pokemon-link"
